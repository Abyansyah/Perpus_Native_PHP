    ...
    <tbody>
        ...
        while($dt_histori=mysqli_fetch_array($qry_histori)){
            ...
            if(mysqli_num_rows($qry_cek_kembali)>0){
                ...
                $button_kembali="";
                $hapus="<td><a href='hapus_pj.php?id_peminjaman_buku=$dt_histori[id_peminjaman_buku]' onclick='return confirm(Apakah anda yakin menghapus data ini?)' class='btn btn-danger'>Hapus</a></td>";
            } else {
